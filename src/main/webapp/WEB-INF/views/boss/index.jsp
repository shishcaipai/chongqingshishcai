...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head id="Head1">
		...
		<script type="text/javascript" src='<%=basePath %>static/js/probizUtil.js'> </script>
	...
	<body class="easyui-layout" style="overflow-y: hidden" scroll="no">
		<div region="north" split="true" border="false"
			...
			<span style="float: right; padding-right: 20px;" class="head">欢迎
				${username } <a href="#" id="editpass"> 修改密码</a> <a href="${pageContext.request.contextPath}/boss/logout" id="loginOut">安全退出</a>
			</span>
			<span style="padding-left: 10px; font-size: 16px; float: left;">
				<img src="<%=basePath %>static/boss/images/blocks.gif" width="20" height="20"
					align="absmiddle" /> 1000-Wan-Web</span>
			<ul id="css3menu"
				style="padding: 0px; margin: 0px; list-type: none; float: left; margin-left: 40px;">
				<li>
					<a class="active" name="user" href="javascript:;" title="用户管理">用户管理</a>
				</li>
				<li>
					<a name="member" href="javascript:;" title="会员管理">会员管理</a>
				</li>
				<li>
					<a name="order" href="javascript:;" title="订单管理">订单管理</a>
				</li>
				<li>
