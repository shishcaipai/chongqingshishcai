...
<body>
	...
	<div id="tb" style="height: auto">
		<form id="queryForm">
			<table>
				...
				<tr>
					...
					<td>审核状态：</td>
					<td><select id="search_auditStatus" style="width: 150px;">
				...
				<tr>
					<td>申请时间：</td>
					<td><input name="applyStartTime" id="applyStartTime"
						class="easyui-datebox" style="width: 150px"></td>
					<td align="right">到:</td>
					<td colspan="3"><input name="applyEndTime" id="applyEndTime"
						class="easyui-datebox" style="width: 150px"></td>
				</tr>
				<tr>
					<td>审核时间：</td>
		...
		<div>
			<a href="javascript:searchApply()" class="easyui-linkbutton"
				...
				iconCls="icon-edit" plain="true">审核</a> <a
	...
	<div id="dlg" class="easyui-window"
		...
		<input type="hidden" 
			...
			<table>
				<tr>
					<td colspan="6" align="right">提款人账号：</td>
					<td colspan="40" align="left"><input type="text"
						name="user_name" id="user_name" readonly="readonly"
						style="overflow: visible;" /></td>
				</tr>
				<tr>
					<td colspan="6" align="right">提款人姓名：</td>
					<td colspan="40" align="left"><input type="text"
						name="apply_name" id="apply_name" readonly="readonly"
						style="overflow: visible;" /></td>
				</tr>
				<tr>
					<td colspan="6" align="right">提款人金额：</td>
					<td colspan="40" align="left"><input type="text"
						name="apply_money" id="apply_money" readonly="readonly"
						style="overflow: visible;" /></td>
				</tr>
				<tr>
					<td colspan="6" align="right">审核状态：</td>
					<td colspan="40"><select type="text" id="audit_status"
						name="audit_status">
	...
	<script type="text/javascript">
		function searchApply() {
			...
			//=======================================
			tradeOrder["applystartDate"] = $("#applyStartTime").datebox(
					'getValue');
		...
		function updateOrder() {
			var  senOrder={};
			senOrder["id"]=$("#id").val();
			senOrder["status"]=$("#audit_status").val();
			//保存
			$.ajax({
				url : '../../boss/applyrecord/ajax_stauts',
				data:senOrder,
				type:'post',
				dataType:'text',
