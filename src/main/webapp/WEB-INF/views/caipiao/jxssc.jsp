...
<script src="<%=basePath%>static/js/Method2.js"
	type="text/javascript"></script>
<script src="<%=basePath%>static/js/Betting2.js?id=1"
	type="text/javascript"></script>
...
<body>
	...
	<script src="<%=basePath%>static/js/ajaxfileupload.js"
		type="text/javascript"></script>
...
//-->
		...
		<ul class="yh_tz01">
			<li class="yh_tz02"><img
				src="<%=basePath%>static/images/11x5.png" width="57" height="57"></li>
			<li class="yh_tz03">
				<div>
					<h2>江西11选5</h2>
				</div>
		...
		<div class="t_tz09">
			<table class="t_tz10" border="0" cellspacing="0" cellpadding="0">
				<tbody>
					<tr>
						<td class="adtd02"><a href="javascript:;" class="menu1 menu2"
							value="1">任选复式</a> <a href="javascript:;" class="menu1" value="2">任选单式</a>
							<a href="javascript:;" class="menu1" value="3">任选胆拖</a> <a
							href="javascript:;" class="menu1" value="4">前三投注</a> <a
							href="javascript:;" class="menu1" value="5">前二投注</a></td>
					</tr>
				</tbody>
			</table>
		</div>
		...
		<div class="Betting">
			<table class="t_tz15" cellpadding="0" cellspacing="0" border="0">
				<tbody>
					<tr>
						<td class="adtd04"><span id="sytz" style=""> <span
								id="c1"><input type="radio" name="radiobutton" value="1">选一</span>
								<span id="c2"><input type="radio" name="radiobutton"
									value="2">选二</span> <span id="c3"><input type="radio"
									name="radiobutton" value="3">选三</span> <span id="c4"><input
									type="radio" name="radiobutton" value="4">选四</span> <span
								id="c5"><input type="radio" name="radiobutton" value="5">选五</span>
								<span id="c6"><input type="radio" name="radiobutton"
									value="6">选六</span> <span id="c7"><input type="radio"
									name="radiobutton" value="7">选七</span> <span id="c8"><input
									type="radio" name="radiobutton" value="8">选八</span>
						</span> <span id="fstz" style="display: none;">直选： <span id="3xfs"><input
									type="radio" name="radiobutton" value="9">复式</span> <span
								id="3xds"><input type="radio" name="radiobutton"
									value="11">单式</span>&nbsp;&nbsp;&nbsp;&nbsp;组选： <span
								id="3xzxfs"><input type="radio" name="radiobutton"
									value="12">复式</span> <span id="3xzxds"><input
									type="radio" name="radiobutton" value="13">单式</span>
						</span> <span id="2xfstz" style="display: none;">直选： <span
								id="2xfs"><input type="radio" name="radiobutton"
									value="14">复式</span> <span id="2xds"><input
									type="radio" name="radiobutton" value="15">单式</span>&nbsp;&nbsp;&nbsp;&nbsp;组选：
								<span id="2xzxfs"><input type="radio" name="radiobutton"
									value="16">复式</span> <span id="2xzxds"><input
									type="radio" name="radiobutton" value="17">单式</span>
						</span></td>
					</tr>
					<tr>
						<td class="t_tz16"><span class="t_tz17"></span><font
							color="#666666"><span id="zhexplain1">（至少选择1个号码投注，选号与开奖号码第1位一致即中奖<font
									color="red">18</font>元。）
							</span></font></td>
					</tr>
					<tr>
						<td class="adtd06">
							<div class="touzhu_kuang">
								...
								<!--胆拖投注 开始-->
								<table id="numtb_dt" cellspacing="0" cellpadding="0"
									...
									<tbody>
										...
										<tr>
											<td class="line_b1 cs_042"
												style="background: none; line-height: 16px;" align="center"
												valign="top" width="62"><br>拖码</td>
											<td>
								...
								<table id="numta" cellspacing="0" cellpadding="0" border="0"
									class="numtbTable" style="display: none; margin-left: 8px;">
									<tbody>
										<tr>
											<td class="line_b1 cs_042" align="center" valign="top"
											...
											<b style="display: inline-block;float: left;">
											 ...
											 -->
												<input type="button" id="button_add" name="button_add"
													class="button_add pointer" value=""
													...
													<tbody>
														<tr>
															<td><input type="checkbox" name="IsZhuihao"
																id="IsZhuihao" onclick="ChangeStatus()"></td>
															<td>追号&nbsp;&nbsp;</td>
															<td><input disabled="disabled" type="checkbox"
																name="ZjStop" value="1" id="ZjStop"></td>
															<td>中奖后停止追号</td>
														</tr>
													</tbody>
												</table>
...
.jsuan .jsqr input {
	...
	width: 125px;
	background: url("http://www.ib18.cn/res/img/jsuan.png") no-repeat;
}
	...
	color: #DE4500;
												...
												<div id="btDiv" style="display: none">
													<div class="beitou_z">
														...
														<select id="btStartList" name="Adigit">
														</select> <label>我要追</label> <input type="text" value="5"
															maxlength="4" size="4" id="btIssueNum" name="sq">
														<span>期</span>
													</div>
													<div class="jsuan">
		...
		<!--投注主体 结束-->
		<script src="/jquery-ui/jquery-1.5.1.min.js" type="text/javascript"
...
#newWinerMq ul>li>span:last-child {
	...
	color: red;
		...
		<script src="http://www.ib18.cn/res/js/jquery-1.7.2.min.js"
			type="text/javascript"></script>
		<script src="http://www.ib18.cn/res/js/jquery.marquee.js"
			type="text/javascript"></script>
		<script type="text/javascript">
$(document).ready(function() {
	var lotteryTypeId = "4";
...
$(function() {
						...
						<li class="yhzt_y03_01">
							<p>
								第 <span id="activeexpectshow1"><span id="buyExpectShow"><span
										id="lastPhase"></span></span></span> 期开奖<br> 开奖时间：<span
									id="qssj"></span>
							</p>
						</li>
	...
	<form id="formh8" name="formh8" method="post" target="_blank">
		<input type="hidden" id="expectlistsuc1" name="expectlistsuc1"
			...
			type="hidden" id="beishulistsuc3" name="beishulistsuc3">
		<!--2013-126-->
		...
		<input type="hidden" id="allmoney" name="allmoney" value=""> <input
