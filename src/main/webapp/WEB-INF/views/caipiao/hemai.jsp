...
<title>发起合买</title>
<link href="<%=basePath %>static/css/bjdc.css" rel="stylesheet" type="text/css">
<link href="<%=basePath %>static/css/public.css" rel="stylesheet" type="text/css">
<script src="<%=basePath %>static/js/ga.js" async="" type="text/javascript"></script>
...
<script type="text/javascript" src="<%=basePath %>static/js/project_fqck.js"></script>
...
<form name="Form1" action="<%=basePath %>hemai/placeorder" method="post" id="Form1" style="margin: 0px;">
  ...
  <table class="listtable" width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
      ...
      <td colspan="2" class="listtable_c" style="padding:10px 0 10px 10px;">
		...
		<table class="fangan_table" style="width:845px;font-size:12px" border="0" cellpadding="0" cellspacing="0">
			  <tbody><tr>
				<th>方案金额</th>
				<th>分成份数</th>
				<th>发起认购</th>
			  ...
			  <tr>
				<td>
					<span class="red_b">￥${order.totalMoney}</span> 元
					<input id="totalmoney" value="${order.totalMoney}" name="allmoney" type="hidden">
				</td>
				<td><input id="divideCount" name="allnum" size="5" tabindex="1" value="" type="text">份，每份<span class="red" id="perMoney">￥0.00</span>元</td>
				<td>
				<input id="buyCount" name="buynum" size="5" tabindex="2" type="text">份，<span class="red" id="buyMoney">￥0.00</span> 元（ <span class="red" id="buyScale">0%</span> ）
				<td style="border-right:none;">
					<input id="isbaodi" name="isbaodi" value="1" tabindex="3" type="checkbox"><input id="baodiCount" name="baodinum" disabled="disabled" value="0" size="5" tabindex="4" type="text">份，<span class="red" id="baodiMoney">￥0.00</span> 元（ <span class="red" id="baodiScale">0%</span> ）
				</td>
			  </tr>
			  <tr>
	  ...
	  <tr>
		...
		<td colspan="2" class="listtable_c" style="padding:10px 0 10px 10px;">
        <span style="display:none"><input name="checkbox" type="checkbox" id="chkViewMore" onclick="hm.showMore.call(this)" checked="checked"></span>
		 
		<textarea id="caseDescription" name="content"  cols="50" rows="3" onkeyup="value=value.replace(/[\d]/g,'') "onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[\d]/g,''))"></textarea>
      最多500个字
		</td>
      </tr>
    ...
    <tr>
      ...
      <td colspan="2" class="listtable_c" style="border-bottom:none; padding-top:10px;">
          <img src="<%=basePath %>/static/images/yh97.png" id="btn_submit"  style="cursor: pointer;" border="0">
        <br>
      </td>  
    </tr>
  </tbody></table>
