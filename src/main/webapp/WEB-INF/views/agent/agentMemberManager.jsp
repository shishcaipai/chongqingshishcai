...
<body>
							...
							<table width="100%" cellspacing="0" cellpadding="0" border="0"
								...
								<thead>
									<tr>
										...
										<th style="text-align: center;" width="20%">成员</th>
										<th style="text-align: center;" width="20%">真实姓名</th>
										<th style="text-align: center;" width="10%">消费总额</th>
											...
											<tbody>
												<tr>
													<td align="center" class="page" id="show_page_div">页次:<b><font
														...
														条记录 <a
														href="<%=basePath%>agent/agentMemberManager?type=0&pageNum=1">首页</a>
														&nbsp;&nbsp;&nbsp;&nbsp; <a
														href="<%=basePath%>agent/agentMemberManager?type=0&pageNum=${requestScope.pageNum == 1 ? 1 : requestScope.pageNum - 1}">上一页</a>&nbsp;&nbsp;&nbsp;&nbsp;
														<a
														href="<%=basePath%>agent/agentMemberManager?type=0&pageNum=${requestScope.pageNum == requestScope.page ? requestScope.pageNum : requestScope.pageNum + 1}">下一页</a>&nbsp;&nbsp;&nbsp;&nbsp;
														<a
														href="<%=basePath%>agent/agentMemberManager?type=0&pageNum=${requestScope.page}">尾页</a>
														&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;跳转: <select
														name="pageNum"
	...
	function change(index) {
		var type = $("#type").val();
		window.location.href = "<%=basePath%>agent/agentMemberManager?type="
					+ type + "&pageNum=" + index;
		}
		function page() {
			var html = "";
