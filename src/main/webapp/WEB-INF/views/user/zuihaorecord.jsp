...
<script type="text/javascript"
	src="http://www.ib18.cn/res/My97DatePicker/WdatePicker.js"></script>
<title>个人中心</title>
</head>
...
<body>
	...
	<div id="account">
		...
		<div class="account_right">
			...
			<div class="p_yd01">
				...
				<div class="p_daohang">
					<ul>
						<li style="float: left;"><b>追号记录</b></li>
					...
					<TABLE cellSpacing=0 cellPadding=0 border="0" border=0
						...
						<TBODY>
							<tr class="page_tzjl01">
								...
								<td width="20%" align="center" valign="middle">彩种</td>
								<td width="20%" align="center" valign="middle">认购金额</td>
								<td width="20%" align="center" valign="middle">认购时间</td>
								<TD align="center" valign="middle">详情</TD>
							...
							<c:forEach var="order" items="${requestScope.orders }">
								<tr class="page_tzjl01">
									...
									<td width="20%" align="center" valign="middle">${order.createDate }</td>
										...
										<tbody>
											<tr>
												<td align="center" class="page" id="show_page_div">页次:<b><font
													...
													条记录 <a href="<%=basePath%>zuihaoRecord?type=0&pageNum=1">首页</a>
													&nbsp;&nbsp;&nbsp;&nbsp; <a
													href="<%=basePath%>zuihaoRecord?type=0&pageNum=${requestScope.pageNum == 1 ? 1 : requestScope.pageNum - 1}">上一页</a>&nbsp;&nbsp;&nbsp;&nbsp;
													<a
													href="<%=basePath%>zuihaoRecord?type=0&pageNum=${requestScope.pageNum == requestScope.page ? requestScope.pageNum : requestScope.pageNum + 1}">下一页</a>&nbsp;&nbsp;&nbsp;&nbsp;
													<a
													href="<%=basePath%>zuihaoRecord?type=0&pageNum=${requestScope.page}">尾页</a>
													&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;跳转: <select
													name="pageNum"
	...
	function change(index) {
		var type = $("#type").val();
		window.location.href = "<%=basePath%>zuihaoRecord?type=" + type
						+ "&pageNum=" + index;
			}
			function page() {
				var html = "";
