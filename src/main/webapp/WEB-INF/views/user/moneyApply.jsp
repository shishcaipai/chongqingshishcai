			...
			<div class="tc_yhzx_k">
				...
				<div class="p_nr">
					...
					<table border="0" cellspacing="0" cellpadding="0"
						class="table_u_all">
						<tr>
							<td class="tikuan_a2"><span class="zlxg_red">*</span>用户姓名：</td>
						...
						<tr>
							...
							<td class="tikuan_a3"><input class="zlxg_srk" value=""
				...
				<div class="modelu">
					...
					<div class="mdbox">
						<div class="serbox serbox2">
							<div class="addin">
								请认真核实提款信息，错误的信息会造成提款失败。 <a href="#">完善并确认个人信息</a>
							</div>
							<table cellpadding="6" cellspacing="6" class="tb2">
								<tr>
									<td align="right">提款人姓名：</td>
									<td><input type="text" id="applyName" class="inp3"
										size="35" /></td>
								</tr>
								<tr>
									<td>提款人身份证号：</td>
									<td><input type="text" id="idCardNo" class="inp3"
										size="35" /></td>
								</tr>
							</table>
						</div>
						...
						<div class="serbox serbox2">
							<table cellpadding="6" cellspacing="6" class="tb2">
								<tr>
									...
									<td><select id="bankCode" style="width: 140px">
											<option value="">请选择银行</option>
											<c:forEach var="bank" items="${requestScope.bankList }">
												<option value="${bank.code }">${bank.name }</option>
											</c:forEach>
								...
								<tr>
									...
									<td><input type="text" id="bamkCardNo" class="inp3"
										size="35" /></td>
								</tr>

								<tr>
									<td align="right">提款金额：</td>
									<td><input id="applyMoney" type="text" class="inp3"
										size="35" /> 元&nbsp;&nbsp; <span class="orange">
											账户可提取金额：${memberUser.availableScore} 元</span></td>
								</tr>
							</table>
