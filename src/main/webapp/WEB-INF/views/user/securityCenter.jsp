		...
		<div class="account_right">
			<div class="userbox">
				...
				<div class="modelu">
					...
					<div class="mdbox">
						<div class="serbox aqjb">
							您的账号安全级别为：<cite>中</cite><em>上次登录：2014-01-14 16:51:25.0</em>
						</div>
							...
							<tr>
								<c:choose>
									<c:when test="${empty memberUser.activated}">
										...
										<td>通过发送验证邮件、激活帐号</td>
										<td><a href="<%=basePath%>user/emailInfo"><img
												src="<%=basePath%>static/images/bd.png" /></a></td>
									</c:when>
									<c:otherwise>
							...
							<tr>
								<c:choose>
									<c:when test="${empty memberUser.bankCode}">
										...
										<td><a href="<%=basePath%>user/bankInfo"><img
												src="<%=basePath%>static/images/bd.png" /></a></td>
									</c:when>
									<c:otherwise>
