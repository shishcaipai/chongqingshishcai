	...
	<div id="account">
		...
		<div class="account_right">
			...
			<div class="p_yd01">
				<div class="p_daohang">
					<ul>
						<li style="float: left;"><b>我的提现记录</b></li>
						<li style="float: right;"></li>
					</ul>
				</div>

				<div class="tc_yhzx_k"></div>

				<div class="tc_yhzx_k">
					<div class="p_nr">
						<form action="<%=basePath%>money/applyrecord/list">
							<table class="table_u_all">
								<tr>
									<td class="pdl8">起始日期：</td>
									<td><input type="text" name='startDate' class="datepicker"
										size="15" /></td>
									<td class="pdl8">终止日期：</td>
									<td><input type="text" name='endDate' class="datepicker"
										size="15" /></td>
