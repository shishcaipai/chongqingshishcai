...
(function($) {
	$.fn.marquee = function(o) {
		...
		o = $.extend({
			...
			timerid: parseInt($(this).attr('timerid')) || 0
		}, o || {});
		...
		if ((o.direction == 'left' && width > divWidth) || 
			...
			if (TimerArr[o.timerid] !=null)
			{
				clearInterval(TimerArr[o.timerid]);
				TimerArr[o.timerid] = null
			}
			TimerArr[o.timerid] = setInterval(_marquee, o.speed);
			
			div.hover(
				function(){tempHoverStep = false},
				function(){tempHoverStep = true;}
			);
		}
		function _marquee() {
			if (!tempHoverStep)
