...
@Controller
@RequestMapping(value = "/jxssc")
public class JiangXiShiShiCaiController {
	 ...
	 * @return
	 */
	@RequestMapping(value = "/jxsscview")
	...
	@RequestMapping(value = "/jxsschistroy")
